...
description: "Provide long‑term project context for Superun"
---

# Custom Knowledge

Inject a shared memory for your project—goals, constraints, design rules, and external references—that Superun will follow in subsequent edits.
