...
## Cross‑tool workflow
- Work in the browser or inside Figma with the official plugin.
- Export design to Figma for detailed editing.

## Patterns Library
- Compose with reusable blocks and templates.
- Keep consistency while iterating quickly.
